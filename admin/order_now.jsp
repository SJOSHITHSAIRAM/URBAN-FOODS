...
<header>
    ...
    <nav class="navbar">
        ...
        <a class="active" href="http://localhost:8081/URBAN-FOODS/admin/order_now.jsp">order</a>
...
<section class="order" id="order">
    ...
    <form action="http://localhost:8081/URBAN-FOODS/admin/order.jsp" method="post">
