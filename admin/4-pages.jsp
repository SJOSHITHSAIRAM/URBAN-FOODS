...
<form action="" id="search-form">
    ...
    <section class="login-form">
        ...
        <form action="#" method="post">
            <h3>ADMIN PAGES</h3>
            <a href="http://localhost:8081/URBAN-FOODS/admin/add-user.jsp"><input type="button" value="Add user &#128100;" class="btn"></a>
            <a href="http://localhost:8081/URBAN-FOODS/admin/show-user.jsp"><input type="button" value="Show user &#128100;" class="btn"></a>
            <a href="http://localhost:8081/URBAN-FOODS/admin/update-user.jsp"><input type="button" value="Update user &#128100;" class="btn"></a>
            <a href="http://localhost:8081/URBAN-FOODS/admin/remove-user.jsp"><input type="button" value="Remove user &#128100;" class="btn"></a>
        </form>
    </section>
    </section>
