...
<header>
    ...
    <nav class="navbar">
        ...
        <a class="active" href="http://localhost:8081/URBAN-FOODS/admin/dishes.jsp">dishes</a>
...
<section class="dishes" id="dishes">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <img src="http://localhost:8081/URBAN-FOODS/images/dish-1.png" alt="">
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/images/dish-2.png" alt="">
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/images/dish-3.png" alt="">
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/images/dish-4.png" alt="">
            <h3>Cheesy Pizza</h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/images/dish-5.png" alt="">
            <h3>Choco Moulds</h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/images/dish-6.png" alt="">
            <h3>Chicken Leg</h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/menu/Apple_salad.jpg" alt="">
            <h3>Fruit Salad</h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/menu/berry_shake.jpg" alt="">
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/menu/Black_forest_cake.jpg" alt="">
            <h3>black forest 🍰</h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/menu/oreo_shake.jpg" alt="">
            <h3>Oreo shake 🍹</h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/menu/samosa.jpg" alt="">
            <h3>samosa </h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/menu/Onion_pakoda.jpg" alt="">
            <h3>Onion pakoda</h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/menu/Bread_pizza.jpg" alt="">
            <h3>Bread Pizza</h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/menu/Cheese_burst.jpg" alt="">
            <h3>Cheese Burst</h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/menu/Chicken_biryani.jpg" alt="">
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/menu/Chicken_leg.jpg" alt="">
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/menu/Chicken_tandoori.jpg" alt="">
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/menu/Choco_shake.jpg" alt="">
            <h3>Choco shake</h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/menu/Mushroom_biryani.jpg" alt="">
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <a href="#" class="fas fa-eye"></a>
            <img src="http://localhost:8081/URBAN-FOODS/menu/paneer_tikka.jpg" alt="">
            <h3>Panner tikka</h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
