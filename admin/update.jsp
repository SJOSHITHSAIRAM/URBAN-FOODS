...
<%
    ...
    try{
        ...
        if(sts == 1){
            response.sendRedirect("http://localhost:8081/URBAN-FOODS/admin/success-update.jsp");
        }
        else{
            response.sendRedirect("http://localhost:8081/URBAN-FOODS/admin/unsuccess-update.jsp");
        }
    }
    catch(Exception e)
    {
